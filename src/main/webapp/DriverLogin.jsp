...
<head>
  ...
  <title>RideEase - Captain Login</title>
  ...
  <main id="main">
    ...
    <section id="DriverLogin" class="about">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 Driver-Login d-flex justify-content-center align-items-stretch" data-aos="fade-right">
          </div>

          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3>Welcome back<font style="color:#1acc8d;"> Captain</font>, Sign in</h3>
            <p>Sign in and start earning with us, with a secure payment method.</p>

            <form action="DriverDashboard.jsp" method="post">
	...
	<div class="col-11 mt-4">
		<center>
	<label>Not a Member? <a href="index.jsp#driver"> Sign up Here!</a></label>	
		</center>
	</div>
