...
try
{
   ...
   int i=st.executeUpdate("insert into customer(Cust_Fname, Cust_Lname, Cust_Email, Cust_Phone, Cust_Pass)values('"+Fname+"','"+Lname+"','"+Email+"','"+Phone+"','"+Pass+"')");
			...
			<svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
			  <div style="margin-left: 20px;">
				<strong>An Error has occured !!</strong>
				  <br>
				  Note: Try with a different username or phone number.
			  </div>
			</div>

    	  <form action="index.jsp#about">
          <div class="row justify-content-center">
